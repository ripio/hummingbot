...
class RipioTradeOrderBookTracker(OrderBookTracker):
    ...
    def __init__(self,
        ...
        super().__init__(RipioTradeAPIOrderBookDataSource(trading_pairs), trading_pairs)
    ...
    def data_source(self) -> OrderBookTrackerDataSource:
        if not self._data_source:
            self._data_source = RipioTradeAPIOrderBookDataSource(trading_pairs=self._trading_pairs)
        ...
        while True:
            try:
                ...
                if message.type is OrderBookMessageType.DIFF:
                    # Ripio Trade websocket messages contain the entire order book state so they should be treated as snapshots
